...
(function () {
  ...
  var MANIFEST = {
    ...
    enemyStooge_Moe:         { file: 'stooge_moe.glb',    height: 1.9 },
    enemyStooge_Larry:       { file: 'stooge_larry.glb',  height: 1.9 },
    enemyStooge_Curly:       { file: 'stooge_curly.glb',  height: 1.9 },
    // ── V22.3.0 — the three that had no 3D form until now ─────────────────
    characterChina:          { file: 'china.glb',         height: 1.9 },
    characterFreakyBlonde:   { file: 'freaky_blonde.glb', height: 1.9 },
    characterDumbass:        { file: 'dumbass.glb',       height: 1.9 },
  ...
  var CLIPS = {
    ...
    enemyStooge_Moe:      { idle:'Idle', walk:'Walk', run:'Run', hit:'Hit', death:'Death' },
    enemyStooge_Larry:    { idle:'Idle', walk:'Walk', run:'Run', hit:'Hit', death:'Death' },
    enemyStooge_Curly:    { idle:'Idle', walk:'Walk', run:'Run', hit:'Hit', death:'Death' },
    characterChina:       { idle:'Idle', walk:'Walk', run:'Run', punch:'Attack', hit:'Hit', death:'Death' },
    characterFreakyBlonde:{ idle:'Idle', walk:'Walk', run:'Run', punch:'Attack', hit:'Hit', death:'Death' },
    characterDumbass:     { idle:'Idle', walk:'Walk', run:'Run', punch:'Attack', hit:'Hit', death:'Death' },
